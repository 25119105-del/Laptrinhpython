...
class MemoryGame:
    ...
    def draw(self):
        ...
        if self.scene == "MENU":
            ...
            self.draw_text("CHỌN CHỦ ĐỀ", (WIDTH//2, 120))
            ...
            draw_button(self.btn_amthuc, (200,50,50), (255,100,100), "Ẩm thực")
            draw_button(self.btn_vanhoa, (50,150,255), (100,200,255), "Văn hóa")
            draw_button(self.btn_lichsu, (50,200,100), (100,255,150), "Lịch sử")
