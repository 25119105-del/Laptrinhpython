...
INFO_DATA = {
    ...
    "Văn hóa": {"Trang phục Dân tộc": {
                ...
                "Phong tục": {
                    "Tết Nguyên Đán": "(Từ cuối tháng Chạp đến mùng 3 Tết): Đây là cái Tết lớn nhất, khi mọi người gác lại lo toan để về nhà sum họp. Không chỉ là dọn dẹp nhà cửa cho sạch sẽ, sáng sủa mà còn là dịp để 'làm mới' tâm hồn, tha thứ cho nhau và cùng chúc nhau một năm mới vạn sự hanh thông, gia đình êm ấm.",
                    "Ông Công Ông Táo": "(Ngày 23 tháng Chạp): Người Việt tin rằng đây là ngày các vị thần bếp cưỡi cá chép lên trời để 'báo cáo' việc lớn nhỏ trong nhà. Hình ảnh phóng sinh cá chép xuống sông hồ không chỉ là nghi lễ tâm linh mà còn thể hiện tấm lòng nhân ái, mong muốn những điều tốt đẹp nhất sẽ đến với gia đình.",
                    "Gói bánh chưng": "(Từ 26 đến 29 Tết): Chiếc bánh vuông vức gói ghém bên trong là gạo nếp, đậu xanh, thịt mỡ - những hạt ngọc của đất trời. Cảm giác cả nhà quây quân bên nồi bánh đỏ lửa, thức xuyên đêm trò chuyện chính là hình ảnh ấm áp nhất của sự đoàn viên và lòng biết ơn tổ tiên.",
                    "Đi chùa đầu năm": "(Từ Giao thừa đến hết tháng Giêng): Giữa không khí tĩnh lặng và mùi hương trầm thơm ngát, người ta đến chùa để tìm sự bình an trong tâm hồn. Tục 'hái lộc' hay xin quẻ đầu năm là cách người Việt gửi gắm hy vọng vào một năm mới sức khỏe dồi dào và gặp nhiều điều may mắn.",
                    "Xin chữ": "(Những ngày đầu tháng Giêng): Hình ảnh ông đồ già bên mực tàu giấy đỏ là nét đẹp tri thức của người Việt. Người ta đi xin chữ không chỉ để trang trí nhà cửa mà còn là cách để rèn tâm, hướng thiện, mong muốn con chữ ấy sẽ vận vào người để cả năm thông tuệ, học hành đỗ đạt.",
                    "Lì xì": "(Từ mùng 1 đến mùng 10 Tết): Những phong bao đỏ thắm chứa đựng niềm vui dành cho con trẻ và sự kính trọng đối với người già. Quan trọng nhất không phải số tiền bên trong, mà là lời chúc 'hay ăn chóng lớn' cho trẻ nhỏ và 'sống lâu trăm tuổi' cho ông bà, cha mẹ.",
                    "Giỗ Tổ Hùng Vương": "(Ngày 10/03 âm lịch): Là ngày để mỗi người dân Việt dù ở đâu cũng hướng về cội nguồn dân tộc. Ngày này nhắc nhở chúng ta về tình đồng bào, về sức mạnh của sự đoàn kết và đạo lý sống đẹp: luôn nhớ về gốc gác, cha ông đã có công dựng nước.",
                    "Tết Trung thu": "(Ngày Rằm tháng Tám âm lịch): Là dịp trăng tròn và đẹp nhất, khi trẻ em được rước đèn, phá cỗ, còn người lớn thì cùng nhau thưởng trà, ăn bánh nướng, bánh dẻo. Đây là cái Tết của sự tình thân, là lúc mọi người dành thời gian chăm sóc và tạo niềm vui cho thế hệ mầm non.",
                    "Lễ cầu ngư": "(Tháng Giêng hoặc tháng Hai âm lịch): Đối với bà con vùng biển, đây là lễ hội quan trọng nhất để cảm ơn biển cả và thờ cúng cá Ông (cá voi). Tiếng hò bả trạo và những cuộc đua ghe sôi động thể hiện niềm tin mãnh liệt vào một mùa biển lặng, tôm cá đầy khoang.",
                    "Rằm tháng Giêng": "(Ngày 15/01 âm lịch): Người xưa có câu 'Lễ Phật quanh năm không bằng Rằm tháng Giêng'. Đây là lúc mọi người đi chùa cầu nguyện cho sự khởi đầu của một năm mới được thuận buồm xuôi gió, công việc hanh thông và mọi sự dữ hóa lành.",
                    "Tục ăn trầu": "(Diễn ra hàng ngày và trong nghi lễ): Miếng trầu cay nồng là 'đầu câu chuyện', giúp mọi người xích lại gần nhau hơn. Dù ngày nay ít người ăn trầu thường xuyên, nhưng trong các dịp lễ tết, cưới hỏi, cơi trầu vẫn là lễ vật quan trọng nhất để thể hiện tình cảm gắn bó, sắt son.",
                    "Tục cưới hỏi": "(Ngày lành tháng tốt): Đám cưới là sự kiện trọng đại, đánh dấu sự gắn kết của hai dòng họ. Từ lễ dạm ngõ đến lễ rước dâu, mỗi chi tiết đều mang ý nghĩa chúc phúc cho đôi trẻ có một đời sống vợ chồng hòa thuận, yêu thương và cùng nhau xây dựng tổ ấm vững bền.",
                    "Lễ mừng thọ": "(Dịp đầu Xuân hoặc sinh nhật): Khi ông bà, cha mẹ bước sang tuổi xế chiều, con cháu tổ chức lễ mừng thọ để tỏ lòng hiếu thảo. Hình ảnh con cháu quây quần chúc rượu, tặng bức tranh chữ 'Thọ' là niềm hạnh phúc lớn nhất của người già, khẳng định giá trị của gia đình.",
                    "Tục tang ma": "(Khi có người thân qua đời): Đây là lúc tình làng nghĩa xóm và lòng hiếu thảo của con cái thể hiện rõ nhất. Các nghi lễ dù buồn thương nhưng luôn được thực hiện chu đáo để tiễn đưa người đã khuất về nơi yên nghỉ cuối cùng một cách thanh thản và trang nghiêm.",
                    "Tục treo câu đối": "(Trước đêm Giao thừa): Những đôi câu đối đỏ dán hai bên cửa không chỉ làm ngôi nhà thêm rực rỡ mà còn là những lời răn dạy về đạo đức, lối sống. Màu đỏ tượng trưng cho may mắn, hy vọng xua đuổi điều không may và đón nhận niềm vui vào nhà.",
                    "Tục uống trà": "(Mọi lúc trong ngày): Người Việt uống trà rất mộc mạc nhưng cũng đầy tinh tế. Một chén trà xanh nóng hổi mời khách hay chén trà ướp hoa thơm dịu của ông bà là cách thể hiện lòng hiếu khách, sự điềm đạm và thói quen sống chậm lại để lắng nghe, chia sẻ với nhau."
                },
               "Địa danh": {
