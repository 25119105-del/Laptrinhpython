...
INFO_DATA = {
    ...
    "Văn hóa": {
        "Trang phục Dân tộc": {
            ...
            "Mường": "Trang phục người Mường mang nét giản dị nhưng tinh tế. Phụ nữ mặc áo cánh ngắn màu trắng hoặc xanh, váy dài màu đen. Điểm đặc biệt là cạp váy được dệt hoa văn rất cầu kỳ với nhiều màu sắc. Thắt lưng màu nổi tạo điểm nhấn. Trang phục thể hiện sự khéo léo trong nghề dệt và gu thẩm mỹ của người Mường.",

            "Nùng": "Trang phục người Nùng thường có màu chàm đặc trưng, được nhuộm từ lá cây tự nhiên. Áo có thiết kế đơn giản, cài cúc vải, không nhiều họa tiết. Tay áo thường có viền sáng màu. Trang phục thể hiện sự mộc mạc, thực tế trong đời sống sinh hoạt của người Nùng.",

            "Pà Thẻn": "Trang phục Pà Thẻn nổi bật với màu đỏ rực rỡ. Phụ nữ đội khăn nhiều lớp, trang trí hoa văn dệt trực tiếp lên vải. Áo và váy có họa tiết độc đáo, mang tính tâm linh cao. Trang phục thường được mặc trong các nghi lễ quan trọng như lễ nhảy lửa.",

            "tày": "Trang phục người Tày đơn giản nhưng thanh lịch. Áo dài màu chàm, không có nhiều hoa văn, kết hợp với thắt lưng xanh. Trang sức bạc như vòng cổ, vòng tay được sử dụng để làm điểm nhấn. Trang phục phản ánh lối sống giản dị và gần gũi thiên nhiên.",
            ...
            "Mảng": "Trang phục người Mảng khá đặc biệt với tấm choàng trắng thêu chỉ đỏ nổi bật. Áo được trang trí bằng nhiều đồng xu bạc, tạo âm thanh khi di chuyển. Trang phục thể hiện nét văn hóa riêng biệt và đời sống gắn với núi rừng.",

            "Sán Dìu": "Trang phục Sán Dìu gồm áo dài bốn thân, váy quấn và xà cạp. Màu sắc chủ yếu là nâu và chàm. Trang phục phù hợp với lao động và sinh hoạt hằng ngày. Ngoài ra còn có khăn đội đầu và trang sức đơn giản.",

            "Thổ": "Trang phục Thổ là sự giao thoa giữa văn hóa Kinh và Mường. Phụ nữ mặc váy đen dài, cạp váy có hoa văn, thắt lưng màu nổi. Áo đơn giản nhưng tinh tế. Trang phục thể hiện sự hòa trộn văn hóa độc đáo giữa các dân tộc."
}},
                "Phong tục": {
